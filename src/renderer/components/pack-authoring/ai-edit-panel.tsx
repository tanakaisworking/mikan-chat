...
export function AiEditPanel({
  ...
  return (
    <div className="fixed top-1/2 right-4 z-40 grid h-[70vh] w-[min(28rem,calc(100vw-2rem))] -translate-y-1/2 grid-rows-[auto_minmax(0,1fr)_auto] overflow-hidden rounded-xl border border-border bg-popover text-foreground shadow-xl" role="dialog" aria-label="AI相談">
