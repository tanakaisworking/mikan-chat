...
export function CharacterStage({ image, idleVideo, name, className }: { image?: string; idleVideo?: string; name: string; className?: string }) {
        ...
        {image || idleVideo ? (
          <>
            {image ? (
              ...
              <div className="grid size-full place-items-center bg-[radial-gradient(circle_at_50%_35%,#ffe1c7_0%,#f8cda8_38%,#d87835_100%)]" role="img" aria-label={`${name}のキャラクタービジュアル`}>
            ...
            {idleVideo && !videoFailed ? (
              <video
                ...
                className="pointer-events-none absolute inset-0 size-full object-cover object-top motion-reduce:hidden max-md:object-[50%_22%]"
